...
@section('content')
    ...
    <main class="bg-white">
        ...
        <div class="global-padding flex">
            <aside id="sidebar-multi-level-sidebar" class="top-0 left-0 z-40 p-2 h-[80vh] mb-2 mt-1 transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
