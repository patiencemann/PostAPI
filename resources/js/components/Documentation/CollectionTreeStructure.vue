        ...
        <li class="mb-10 ml-6 pr-3" v-if="folder.hasOwnProperty('request')">
            ...
            <div v-if="folder.request?.body !== undefined" class="w-full mb-4 mt-3 ring-2 ring-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800 overflow-x-auto">
                    ...
                    <textarea v-if="folder.request.body?.raw !== undefined" id="editor" :value="folder.request.body.raw" disabled rows="8" class="block font-medium leading-7 text-gray-500 w-full px-0 text-[17px] bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
